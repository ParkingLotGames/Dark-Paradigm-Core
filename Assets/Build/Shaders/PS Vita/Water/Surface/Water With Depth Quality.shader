...
Shader "PS Vita/Water/With Depth/Quality" {
    Properties {
        ...
        _BlendDistance ("Blend Distance", Float ) = 10
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Emissive:
                ...
                float3 emissive = (lerp(_Shallow.rgb,_Deep.rgb,pow(1.0-max(0,dot(normalDirection, viewDirection)),_BlendDistance))*_MainTexture_var.rgb);
/// Final Color:
