...
Shader "PS Vita/Vertex Lit/Environment/Lightmap + Wind" {
Properties {
	_MainTex ("Base (RGB) Gloss (A)", 2D) = "white" {}
	_Wind("Wind Params",Vector) = (1,1,1,1)
	_WindEdgeFlutter("Edge Wind Flutter Factor", float) = 0.5
	_WindEdgeFlutterFreqScale("Edge Wind Flutter Freq Scale",float) = 0.5
}
